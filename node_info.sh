...
while test $# -gt 0; do
	...
	-h|--help)
		...
		echo -e "https://github.com/SecorD0/DWS/blob/main/node_info.sh - script URL"
...
main() {
	...
	# Send Pull request with new texts to add a language - https://github.com/SecorD0/DWS/blob/main/node_info.sh
	#elif [ "$language" = ".." ]; then
	else
